...
public class Utils {
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        String ip = null;
        Enumeration<String> ips = request.getHeaders(ALI_CDN_REAL_IP);
     ...
     * @return
     */
    public static String flowAutoShow(long value) {
        int kb = 1024;
        int mb = 1048576;
        int gb = 1073741824;
    ...
    public static String getRandomChar(int size) {
        ...
        for(int i = 0; i < size; ++i) {
            String ch = String.valueOf("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789".charAt(random.nextInt("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789".length())));
            sRand = sRand + ch;
        }
